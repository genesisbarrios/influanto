...
export default function Dashboard() {
  ...
  return (
    <div className="flex min-h-screen bg-base-200 text-xs md:text-md">
      {/* Sidebar menu */}
      <aside className="w-1/4 sm:w-1/3 p-4 bg-base-100 sm:w-1/3 sm:p-8">
        ...
        <li>
          ...
          <li>
            <button className="block p-2 hover:bg-blue-100 w-full" onClick={() => setActiveComponent('pitch-to-spotify')}>Playlist Search</button>
          </li>
          <li>
