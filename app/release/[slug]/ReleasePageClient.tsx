...
const ReleasePageView = () => {
  ...
  // <title>/<meta> tags are set server-side via generateMetadata in page.tsx
  // (needed for share-preview crawlers, which don't execute this JS). This
  // effect only adds JSON-LD structured data for Google rich results, since
  // Google's crawler does execute client JS and picks up injected script tags.
  useEffect(() => {
