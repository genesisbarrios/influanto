...
// Page-level <meta>/<title> tags are set server-side via generateMetadata in
// page.tsx (needed for share-preview crawlers, which don't execute this JS).
// This effect only keeps author/keywords tags in sync for in-browser use.
useEffect(() => {
  if (user && userName) {
    // Update author
